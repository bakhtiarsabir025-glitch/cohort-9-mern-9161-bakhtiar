...
class NoteModel {
    static async create(token, userId, data) {
        try {
            ...
            logger.error(`NoteModel.create failed: ${error.message}`);
            throw error;
        }
    }
    ...
    static async findById(token, noteId, includeDeleted = false) {
        try {
            ...
            if (error.code !== 'PGRST116') {
                logger.error(`NoteModel.findById failed: ${error.message}`);
            }
            throw error;
        }
    }
    ...
    static async update(token, noteId, updates) {
        try {
            ...
            logger.error(`NoteModel.update failed: ${error.message}`);
            throw error;
        }
    }
    ...
    static async softDelete(token, noteId) {
        try {
            ...
            logger.error(`NoteModel.softDelete failed: ${error.message}`);
            throw error;
        }
    }
    ...
    static async restore(token, noteId) {
        try {
            ...
            logger.error(`NoteModel.restore failed: ${error.message}`);
            throw error;
        }
    }
    ...
    static async hardDelete(token, noteId) {
        try {
            ...
            logger.error(`NoteModel.hardDelete failed: ${error.message}`);
            throw error;
        }
    }
    ...
    static async togglePin(token, noteId) {
        try {
            ...
            logger.error(`NoteModel.togglePin failed: ${error.message}`);
            throw error;
        }
    }
    ...
    static async getCategories(token) {
        try {
            ...
            logger.error(`NoteModel.getCategories failed: ${error.message}`);
            throw error;
        }
    }
    ...
    static async getStats(token) {
        try {
            ...
            logger.error(`NoteModel.getStats failed: ${error.message}`);
            throw error;
        }
    }
}
